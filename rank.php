    ...
    <div style="background: linear-gradient(135deg, #187bcb 0%, #6c5ce7 100%); color: white; padding: 10px 20px; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <?php if ($usuario_logado): ?>
                <span>✅ Logado como: <?php echo htmlspecialchars($nome_usuario); ?></span>
            <?php else: ?>
                <span>❌ Você não está logado</span>
            <?php endif; ?>
        </div>
        <div style="display: flex; gap: 10px;">
            <a href="index.php" style="color: white; text-decoration: none; background: rgba(255,255,255,0.2); padding: 8px 16px; border-radius: 20px;">🏠 Início</a>
            <?php if ($usuario_logado): ?>
                ...
                <div class="footer-links">
                    <div class="footer-column">
                        ...
                        <ul>
                            ...
                            <li><a href="rank.php"><i class="fas fa-trophy"></i> Rank Universidades</a></li>
                        </ul>
                    </div>
