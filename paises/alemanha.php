...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'alemanha');
...
<head>
    ...
    <title>Alemanha - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/de.png" alt="Bandeira da Alemanha" class="country-flag">
                            <h1 class="country-title">Alemanha</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Alemanha
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/alemanha_home.png" alt="Alemanha - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇩🇪 Guia Completo: Estudar na Alemanha</h2>
        <p>Descubra a potência econômica e educacional da Europa</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="alemanhaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="alemanhaTabContent">
            <!-- Idioma Oficial -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Alemão (Deutsch)</strong> é o idioma oficial da Alemanha, falado por mais de 100 milhões de pessoas na Europa. É uma língua germânica com rica tradição acadêmica e científica.</p>

                <div class="row">
                    <div class="col-md-6">
                        <h5>🇩🇪 Alemão (Deutsch)</h5>
                        <ul>
                            <li><strong>Falantes:</strong> 83 milhões na Alemanha</li>
                            <li><strong>Mundial:</strong> 100+ milhões de falantes</li>
                            <li><strong>Família:</strong> Germânica ocidental</li>
                            <li><strong>Características:</strong> Casos gramaticais, palavras compostas</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h5>🌍 Inglês na Educação</h5>
                        <ul>
                            <li><strong>Programas em inglês:</strong> Mais de 1.000 programas disponíveis</li>
                            <li><strong>Universidades top:</strong> Muitos cursos internacionais</li>
                ...
                <div class="highlight-box">
                    ...
                    <ul>
                        <li><strong>Dificuldade:</strong> Moderada a difícil para falantes de português</li>
                        <li><strong>Casos gramaticais:</strong> 4 casos (Nominativ, Akkusativ, Dativ, Genitiv)</li>
                        <li><strong>Palavras compostas:</strong> Característica única do alemão</li>
                ...
                <ul>
                    <li><strong>TestDaF:</strong> Teste de alemão como língua estrangeira</li>
                    <li><strong>DSH:</strong> Exame de alemão para acesso ao ensino superior</li>
                    <li><strong>Goethe-Zertifikat:</strong> Certificados do Instituto Goethe</li>
                    <li><strong>Nível exigido:</strong> B2-C1 para graduação, C1-C2 para pós</li>
                </ul>

                <h5>🏫 Aprendendo Alemão:</h5>
                <ul>
                    <li><strong>Instituto Goethe:</strong> Presente em várias cidades brasileiras</li>
                    <li><strong>Duolingo:</strong> Curso gratuito de alemão</li>
                    <li><strong>Apps recomendados:</strong> Babbel, Busuu, Nemo</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Alemanha possui <strong>clima temperado continental</strong>, com quatro estações bem definidas. Invernos frios e verões amenos caracterizam o país.</p>
                <ul>
                    <li><strong>Inverno (Dez-Fev):</strong> -2 a 4°C, neve comum</li>
                    <li><strong>Primavera (Mar-Mai):</strong> 5-15°C, agradável</li>
                    <li><strong>Verão (Jun-Ago):</strong> 15-25°C, ocasionalmente 30°C</li>
                    <li><strong>Outono (Set-Nov):</strong> 8-18°C, chuvoso</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Alemanha oferece <strong>excelente custo-benefício</strong> com educação gratuita e custos de vida moderados.</p>
                <ul>
                    <li><strong>Acomodação:</strong> €300-800/mês</li>
                    <li><strong>Alimentação:</strong> €200-300/mês</li>
                    <li><strong>Transporte:</strong> €80-200/mês</li>
                    <li><strong>Total:</strong> €700-1500/mês</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Alemanha oferece <strong>educação superior gratuita</strong> e diversas bolsas para estudantes internacionais.</p>
                <ul>
                    <li><strong>DAAD Scholarships:</strong> Principal programa alemão
                        <br><a href="https://www.daad.de/en/" target="_blank" class="btn-custom">🔗 DAAD</a>
                    </li>
                    <li><strong>Deutschlandstipendium:</strong> €300/mês para estudantes talentosos</li>
                    <li><strong>Erasmus+:</strong> Para estudantes europeus</li>
                    <li><strong>Educação gratuita:</strong> Universidades públicas sem taxas</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Alemanha possui <strong>universidades de classe mundial</strong> com forte tradição em pesquisa e inovação.</p>
                <ul>
                    <li><strong>Technical University of Munich:</strong> #50 mundial
                        <br><a href="https://www.tum.de/en/" target="_blank" class="btn-custom">🔗 TUM</a>
                    </li>
                    <li><strong>LMU Munich:</strong> #54 mundial
                        <br><a href="https://www.lmu.de/en/" target="_blank" class="btn-custom">🔗 LMU</a>
                    </li>
                    <li><strong>Heidelberg University:</strong> #64 mundial
                        <br><a href="https://www.uni-heidelberg.de/en" target="_blank" class="btn-custom">🔗 Heidelberg</a>
                    </li>
                    <li><strong>400.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Alemanha possui uma <strong>comunidade brasileira de 150.000 pessoas</strong>, bem estabelecida e ativa.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Berlim, Munique, Frankfurt, Hamburgo</li>
                    <li><strong>Organizações:</strong> Câmara Brasil-Alemanha, grupos culturais</li>
                    <li><strong>Eventos:</strong> Festival do Brasil, Carnaval, Festa Junina</li>
                    <li><strong>Recursos:</strong> Consulados, grupos no Facebook, restaurantes</li>
                </ul>
            </div>

            <!-- Cultura -->
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-beer me-2"></i>Cultura e Costumes</h4>
                <p>A cultura alemã valoriza <strong>pontualidade, eficiência e tradições</strong>.</p>
                <ul>
                    <li><strong>Pontualidade:</strong> Extremamente importante</li>
                    <li><strong>Oktoberfest:</strong> Festival da cerveja mundialmente famoso</li>
                    <li><strong>Mercados de Natal:</strong> Tradição centenária</li>
                    <li><strong>Reciclagem:</strong> Cultura ambiental muito forte</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico alemão tem <strong>dois semestres</strong>: Wintersemester e Sommersemester.</p>
                <ul>
                    <li><strong>Wintersemester:</strong> Outubro-março</li>
                    <li><strong>Sommersemester:</strong> Abril-setembro</li>
                    <li><strong>Aplicações:</strong> Até 15 de julho (inverno), 15 de janeiro (verão)</li>
                    <li><strong>Férias:</strong> Agosto-setembro, fevereiro-março</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Alemanha, foque em <strong>excelência acadêmica e proficiência em alemão</strong>.</p>
                <ul>
                    <li><strong>Alemão:</strong> TestDaF ou DSH B2-C1</li>
                    <li><strong>Documentos:</strong> Histórico, diploma, carta de motivação</li>
                    <li><strong>CV alemão:</strong> Formato específico com foto</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.study-in-germany.de/" target="_blank" class="btn-custom">🎓 Study in Germany</a>
                        <br><a href="https://www.daad.de/" target="_blank" class="btn-custom">🏆 DAAD</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Sim!</strong> Estudantes podem trabalhar 120 dias/ano ou 240 meio-períodos.</p>
                <ul>
                    <li><strong>Permissão:</strong> 120 dias tempo integral ou 240 meio-períodos</li>
                    <li><strong>Salário:</strong> €9.60-15/hora</li>
                    <li><strong>Setores:</strong> Hospitality, retail, assistente de pesquisa</li>
                    <li><strong>Pós-graduação:</strong> 18 meses para procurar trabalho</li>
                </ul>
            </div>
        </div>
    </div>
