...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'suecia');
...
<head>
    ...
    <title>Suécia - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/se.png" alt="Bandeira da Suécia" class="country-flag">
                            <h1 class="country-title">Suécia</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Suécia
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/suecia_home.png" alt="Suécia - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇸🇪 Guia Completo: Estudar na Suécia</h2>
        <p>Descubra a terra da inovação, sustentabilidade e educação gratuita de excelência</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="sueciaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="sueciaTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Sueco</strong> é o idioma oficial, mas a Suécia tem excelente proficiência em inglês. Muitos programas são oferecidos em inglês.</p>
                <ul>
                    <li><strong>Sueco:</strong> 10,5 milhões de falantes</li>
                    <li><strong>Inglês:</strong> 90%+ de proficiência - um dos países mais fluentes</li>
                    <li><strong>Programas em inglês:</strong> 900+ programas disponíveis</li>
                    <li><strong>Requisitos:</strong> IELTS 6.5-7.0 ou TOEFL 90-100</li>
                    <li><strong>Vantagem:</strong> Inglês suficiente para vida cotidiana</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Suécia possui <strong>clima temperado continental</strong> com invernos longos e frios, verões amenos e aurora boreal.</p>
                <ul>
                    <li><strong>Inverno (Nov-Mar):</strong> -15 a 0°C, neve abundante</li>
                    <li><strong>Primavera (Abr-Mai):</strong> 0-15°C, degelo</li>
                    <li><strong>Verão (Jun-Ago):</strong> 15-25°C, noites brancas</li>
                    <li><strong>Outono (Set-Out):</strong> 5-15°C, aurora boreal</li>
                    <li><strong>Especial:</strong> Sol da meia-noite no norte, noite polar no inverno</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Suécia tem <strong>custo de vida alto</strong>, mas oferece educação gratuita e excelente qualidade de vida.</p>
                <ul>
                    <li><strong>Acomodação:</strong> SEK 4.000-12.000/mês (€380-1.140)</li>
                    <li><strong>Alimentação:</strong> SEK 2.500-4.000/mês (€240-380)</li>
                    <li><strong>Transporte:</strong> SEK 600-900/mês (€57-85)</li>
                    <li><strong>Total:</strong> SEK 8.000-18.000/mês (€760-1.710)</li>
                    <li><strong>Vantagem:</strong> Educação superior gratuita</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Suécia oferece <strong>educação gratuita</strong> e diversas bolsas para custos de vida.</p>
                <ul>
                    <li><strong>Educação gratuita:</strong> Para estudantes da UE/EEE
                        <br><a href="https://studyinsweden.se/" target="_blank" class="btn-custom">🔗 Study in Sweden</a>
                    </li>
                    <li><strong>Swedish Institute Scholarships:</strong> Para países em desenvolvimento
                        <br><a href="https://si.se/" target="_blank" class="btn-custom">🔗 Swedish Institute</a>
                    </li>
                    <li><strong>University scholarships:</strong> Cada universidade oferece programas</li>
                    <li><strong>Taxas para não-UE:</strong> SEK 80.000-140.000/ano</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Suécia possui <strong>universidades de excelência</strong> com forte tradição em pesquisa e inovação.</p>
                <ul>
                    <li><strong>Karolinska Institute:</strong> #7 mundial em medicina
                        <br><a href="https://ki.se/en" target="_blank" class="btn-custom">🔗 KI</a>
                    </li>
                    <li><strong>KTH Royal Institute of Technology:</strong> #73 mundial
                        <br><a href="https://www.kth.se/en" target="_blank" class="btn-custom">🔗 KTH</a>
                    </li>
                    <li><strong>Lund University:</strong> #75 mundial
                        <br><a href="https://www.lunduniversity.lu.se/" target="_blank" class="btn-custom">🔗 Lund</a>
                    </li>
                    <li><strong>40.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Suécia possui uma <strong>pequena comunidade brasileira</strong> de aproximadamente 8.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Estocolmo, Gotemburgo, Malmö</li>
                    <li><strong>Setores:</strong> Tecnologia, pesquisa, design, sustentabilidade</li>
                    <li><strong>Organizações:</strong> Associação Brasil-Suécia</li>
                    <li><strong>Recursos:</strong> Embaixada em Estocolmo</li>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-tree me-2"></i>Cultura e Costumes</h4>
                <p>A cultura sueca valoriza <strong>igualdade, sustentabilidade e simplicidade</strong> com forte conexão com a natureza.</p>
                <ul>
                    <li><strong>Lagom:</strong> Filosofia do equilíbrio e moderação</li>
                    <li><strong>Allemansrätten:</strong> Direito de acesso à natureza</li>
                    <li><strong>Igualdade:</strong> Sociedade muito igualitária</li>
                    <li><strong>Sustentabilidade:</strong> Líder mundial em energia limpa</li>
                    <li><strong>Work-life balance:</strong> Excelente equilíbrio vida-trabalho</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico sueco segue o <strong>padrão europeu</strong> com dois semestres.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Agosto-janeiro</li>
                    <li><strong>Segundo semestre:</strong> Janeiro-junho</li>
                    <li><strong>Aplicações:</strong> Até 15 de janeiro (universityadmissions.se)</li>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Suécia, foque em <strong>excelência acadêmica e interesse em sustentabilidade</strong>.</p>
                <ul>
                    ...
                    <li><strong>Universityadmissions.se:</strong> Portal central de aplicações</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://studyinsweden.se/" target="_blank" class="btn-custom">🎓 Study in Sweden</a>
                        <br><a href="https://www.universityadmissions.se/" target="_blank" class="btn-custom">🏆 University Admissions</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Sim!</strong> Estudantes podem trabalhar sem limitação de horas durante estudos.</p>
                <ul>
                    <li><strong>Permissão:</strong> Sem limitação de horas + tempo integral nas férias</li>
                    <li><strong>Salário:</strong> SEK 120-180/hora (€11-17)</li>
                    <li><strong>Setores:</strong> Tecnologia, pesquisa, design, sustentabilidade</li>
                    <li><strong>Pós-graduação:</strong> 6 meses para procurar trabalho</li>
                    <li><strong>Vantagem:</strong> Salários altos compensam custos</li>
                </ul>
            </div>
        </div>
    </div>
