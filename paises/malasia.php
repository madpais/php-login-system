...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'malasia');
...
<head>
    ...
    <title>Malásia - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/my.png" alt="Bandeira da Malásia" class="country-flag">
                            <h1 class="country-title">Malásia</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Malásia
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/malasia_home.png" alt="Malásia - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇲🇾 Guia Completo: Estudar na Malásia</h2>
        <p>Descubra a Ásia Verdadeiramente com diversidade cultural e custos acessíveis</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="tab-content" id="malasiaTabContent">
            ...
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                ...
                <p>A Malásia é <strong>multilíngue</strong> com Bahasa Malaysia como idioma oficial e inglês amplamente usado na educação.</p>
                <ul>
                    <li><strong>Bahasa Malaysia:</strong> Idioma oficial nacional</li>
                    <li><strong>Inglês:</strong> Amplamente falado, usado na educação superior</li>
                    <li><strong>Chinês e Tamil:</strong> Idiomas reconhecidos</li>
                    <li><strong>Programas em inglês:</strong> Maioria das universidades</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Malásia possui <strong>clima tropical equatorial</strong> quente e úmido o ano todo com duas estações de monção.</p>
                <ul>
                    <li><strong>Temperatura:</strong> 24-32°C constante</li>
                    <li><strong>Umidade:</strong> 70-90% alta umidade</li>
                    <li><strong>Monção nordeste:</strong> Novembro-março</li>
                    <li><strong>Monção sudoeste:</strong> Maio-setembro</li>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Malásia oferece <strong>excelente custo-benefício</strong> com padrão de vida alto e custos baixos.</p>
                <ul>
                    <li><strong>Acomodação:</strong> RM 400-1.500/mês (€80-300)</li>
                    <li><strong>Alimentação:</strong> RM 300-600/mês (€60-120)</li>
                    <li><strong>Transporte:</strong> RM 100-200/mês (€20-40)</li>
                    <li><strong>Total:</strong> RM 1.000-2.500/mês (€200-500)</li>
                    <li><strong>Vantagem:</strong> Qualidade de vida asiática com custos baixos</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Malásia oferece <strong>diversas bolsas</strong> e taxas educacionais muito competitivas.</p>
                <ul>
                    <li><strong>Malaysia International Scholarship (MIS):</strong> Bolsa governamental
                        <br><a href="https://www.studymalaysia.com/" target="_blank" class="btn-custom">🔗 Study Malaysia</a>
                    </li>
                    <li><strong>University scholarships:</strong> Cada universidade oferece programas</li>
                    <li><strong>ASEAN scholarships:</strong> Para países da região</li>
                    <li><strong>Baixas taxas:</strong> RM 15.000-40.000/ano (€3.000-8.000)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Malásia possui <strong>universidades em ascensão</strong> com programas internacionais de qualidade.</p>
                <ul>
                    <li><strong>University of Malaya (UM):</strong> #70 mundial, mais prestigiosa
                        <br><a href="https://www.um.edu.my/" target="_blank" class="btn-custom">🔗 UM</a>
                    </li>
                    <li><strong>Universiti Putra Malaysia (UPM):</strong> #158 mundial
                        <br><a href="https://www.upm.edu.my/" target="_blank" class="btn-custom">🔗 UPM</a>
                    </li>
                    <li><strong>Universiti Kebangsaan Malaysia (UKM):</strong> #159 mundial
                        <br><a href="https://www.ukm.my/" target="_blank" class="btn-custom">🔗 UKM</a>
                    </li>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Malásia possui uma <strong>pequena comunidade brasileira</strong> de aproximadamente 800 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Kuala Lumpur, Penang, Johor Bahru</li>
                    <li><strong>Setores:</strong> Educação, negócios, petróleo e gás</li>
                    <li><strong>Organizações:</strong> Câmara Brasil-Malásia</li>
                    <li><strong>Recursos:</strong> Embaixada em Kuala Lumpur</li>
                    <li><strong>Crescimento:</strong> Comunidade em expansão</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                ...
                <p>A cultura malaia é <strong>multicultural</strong> com influências malaias, chinesas, indianas e ocidentais.</p>
                <ul>
                    <li><strong>Diversidade:</strong> Malaios (69%), chineses (23%), indianos (7%)</li>
                    <li><strong>Religião:</strong> Islã (oficial), budismo, hinduísmo, cristianismo</li>
                    <li><strong>Hospitalidade:</strong> "Malaysia Truly Asia" - muito acolhedora</li>
                    <li><strong>Culinária:</strong> Fusão única de sabores asiáticos</li>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico malaio segue <strong>dois semestres</strong> com início em setembro/outubro.</p>
                <ul>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Malásia, foque em <strong>boa performance acadêmica e interesse na diversidade asiática</strong>.</p>
                <ul>
                    ...
                    <li><strong>Processo:</strong> Relativamente simples e rápido</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studymalaysia.com/" target="_blank" class="btn-custom">🎓 Study Malaysia</a>
                        <br><a href="https://educationmalaysia.gov.my/" target="_blank" class="btn-custom">🏆 Education Malaysia</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <ul>
                    <li><strong>Permissão:</strong> 20h/semana apenas durante férias</li>
                    <li><strong>Setores:</strong> Restaurantes, varejo, ensino</li>
                    <li><strong>Salário:</strong> RM 8-15/hora</li>
