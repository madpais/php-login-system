...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'espanha');
...
<head>
    ...
    <title>Espanha - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/es.png" alt="Bandeira da Espanha" class="country-flag">
                            <h1 class="country-title">Espanha</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Espanha
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/espanha_home.png" alt="Espanha - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇪🇸 Guia Completo: Estudar na Espanha</h2>
        <p>Descubra a terra da paixão, arte e tradições com educação de qualidade europeia</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="espanhaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="espanhaTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Espanhol (Castelhano)</strong> é o idioma oficial, facilitando muito a adaptação para brasileiros devido às semelhanças com o português.</p>
                <ul>
                    <li><strong>Espanhol:</strong> 47 milhões de falantes na Espanha</li>
                    <li><strong>Idiomas regionais:</strong> Catalão, Basco, Galego</li>
                    <li><strong>Vantagem:</strong> Facilidade de aprendizado para brasileiros</li>
                    <li><strong>Programas em inglês:</strong> Disponíveis em universidades principais</li>
                    <li><strong>Requisitos:</strong> DELE B2/C1 ou IELTS 6.0-6.5</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Espanha possui <strong>clima mediterrâneo</strong> com verões quentes e secos, invernos amenos e muito sol.</p>
                <ul>
                    <li><strong>Costa mediterrânea:</strong> Quente e seco, 300+ dias de sol</li>
                    <li><strong>Norte:</strong> Oceânico - mais chuvoso e fresco</li>
                    <li><strong>Centro:</strong> Continental - verões quentes, invernos frios</li>
                    <li><strong>Temperaturas:</strong> 5-15°C (inverno), 25-35°C (verão)</li>
                    <li><strong>Vantagem:</strong> Clima agradável a maior parte do ano</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Espanha oferece <strong>bom custo-benefício</strong> com qualidade de vida europeia e custos moderados.</p>
                <ul>
                    <li><strong>Acomodação:</strong> €300-700/mês</li>
                    <li><strong>Alimentação:</strong> €200-400/mês</li>
                    <li><strong>Transporte:</strong> €20-50/mês (estudante)</li>
                    <li><strong>Total:</strong> €600-1.400/mês</li>
                    <li><strong>Vantagem:</strong> Mais barato que França, Alemanha ou Reino Unido</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Espanha oferece <strong>diversas bolsas</strong> e programas de intercâmbio para estudantes internacionais.</p>
                <ul>
                    <li><strong>Erasmus+:</strong> Para estudantes europeus e parceiros
                        <br><a href="https://www.erasmusplus.es/" target="_blank" class="btn-custom">🔗 Erasmus+ España</a>
                    </li>
                    <li><strong>Becas MAEC-AECID:</strong> Bolsas do governo espanhol
                        <br><a href="https://www.aecid.es/" target="_blank" class="btn-custom">🔗 AECID</a>
                    </li>
                    <li><strong>Fundación Carolina:</strong> Para América Latina
                        <br><a href="https://www.fundacioncarolina.es/" target="_blank" class="btn-custom">🔗 Fundación Carolina</a>
                    </li>
                    <li><strong>Baixas taxas:</strong> €750-2.500/ano em universidades públicas</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Espanha possui <strong>universidades históricas</strong> com tradição centenária e excelência reconhecida.</p>
                <ul>
                    <li><strong>Universidad Complutense de Madrid:</strong> #206 mundial, mais antiga
                        <br><a href="https://www.ucm.es/" target="_blank" class="btn-custom">🔗 UCM</a>
                    </li>
                    <li><strong>Universidad de Barcelona:</strong> #184 mundial
                        <br><a href="https://www.ub.edu/" target="_blank" class="btn-custom">🔗 UB</a>
                    </li>
                    <li><strong>Universidad Autónoma de Madrid:</strong> #200 mundial
                        <br><a href="https://www.uam.es/" target="_blank" class="btn-custom">🔗 UAM</a>
                    </li>
                    <li><strong>120.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Espanha possui uma <strong>grande comunidade brasileira</strong> de aproximadamente 150.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Madrid, Barcelona, Valencia, Sevilha</li>
                    <li><strong>Organizações:</strong> Casa do Brasil, associações regionais</li>
                    <li><strong>Eventos:</strong> Carnaval, Festival do Brasil, eventos culturais</li>
                    <li><strong>Recursos:</strong> Consulados, mídia brasileira, restaurantes</li>
                    <li><strong>Integração:</strong> Facilitada pela proximidade linguística</li>
                </ul>
            </div>

            <!-- Cultura -->
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-guitar me-2"></i>Cultura e Costumes</h4>
                <p>A cultura espanhola valoriza <strong>família, tradições e paixão pela vida</strong> com rica herança artística.</p>
                <ul>
                    <li><strong>Siesta:</strong> Pausa tradicional no meio do dia</li>
                    <li><strong>Tapas:</strong> Cultura gastronômica social</li>
                    <li><strong>Flamenco:</strong> Patrimônio cultural da humanidade</li>
                    <li><strong>Festivais:</strong> La Tomatina, San Fermín, Semana Santa</li>
                    <li><strong>Arte:</strong> Picasso, Dalí, Goya, Velázquez</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico espanhol segue o <strong>padrão europeu</strong> com dois semestres.</p>
                <ul>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Espanha, aproveite a <strong>proximidade linguística e cultural</strong> com o Brasil.</p>
                <ul>
                    <li><strong>Espanhol:</strong> DELE B2/C1 ou certificado equivalente</li>
                    <li><strong>Documentos:</strong> Histórico, diploma, carta de motivação</li>
                    <li><strong>Homologação:</strong> Processo de reconhecimento de títulos</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.educacionyfp.gob.es/" target="_blank" class="btn-custom">🎓 Educación España</a>
                        <br><a href="https://www.fundacioncarolina.es/" target="_blank" class="btn-custom">🏆 Fundación Carolina</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <ul>
                    ...
                    <li><strong>Salário:</strong> €8-12/hora (salário mínimo)</li>
                    <li><strong>Setores:</strong> Turismo, ensino, tradução, serviços</li>
                    <li><strong>Pós-graduação:</strong> 1 ano para procurar trabalho</li>
                    <li><strong>Vantagem:</strong> Facilidade pelo idioma similar</li>
                </ul>
            </div>
        </div>
    </div>
