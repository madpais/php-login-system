...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'italia');
...
<head>
    ...
    <title>Itália - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/it.png" alt="Bandeira da Itália" class="country-flag">
                            <h1 class="country-title">Itália</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Itália
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/italia_home.png" alt="Itália - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇮🇹 Guia Completo: Estudar na Itália</h2>
        <p>Descubra o berço da arte, cultura e gastronomia mundial</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="italiaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="italiaTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Italiano</strong> é o idioma oficial da Itália, uma língua românica melodiosa e expressiva. Muitos programas são oferecidos em inglês para estudantes internacionais.</p>
                <ul>
                    <li><strong>Italiano:</strong> 65 milhões de falantes nativos</li>
                    <li><strong>Família românica:</strong> Derivada do latim</li>
                    <li><strong>Programas em inglês:</strong> 500+ programas disponíveis</li>
                    <li><strong>Requisitos:</strong> IELTS 6.0-6.5 ou TOEFL 80-90</li>
                    <li><strong>Italiano básico:</strong> Recomendado para vida cotidiana</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Itália possui <strong>clima mediterrâneo</strong> com verões quentes e secos, invernos amenos e muitos dias ensolarados.</p>
                <ul>
                    <li><strong>Norte:</strong> Continental - invernos frios, verões quentes</li>
                    <li><strong>Centro:</strong> Mediterrâneo - ameno o ano todo</li>
                    <li><strong>Sul:</strong> Mediterrâneo quente - verões muito quentes</li>
                    <li><strong>Temperaturas:</strong> 5-15°C (inverno), 20-30°C (verão)</li>
                    <li><strong>Melhor época:</strong> Abril-junho, setembro-outubro</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Itália oferece <strong>custo de vida moderado</strong> com variações significativas entre norte (mais caro) e sul (mais barato).</p>
                <ul>
                    <li><strong>Acomodação:</strong> €300-800/mês</li>
                    <li><strong>Alimentação:</strong> €200-350/mês</li>
                    <li><strong>Transporte:</strong> €25-50/mês (estudante)</li>
                    <li><strong>Total:</strong> €700-1500/mês</li>
                    <li><strong>Vantagem:</strong> Excelente qualidade de vida</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Itália oferece <strong>diversas bolsas</strong> e educação pública com taxas acessíveis para estudantes internacionais.</p>
                <ul>
                    <li><strong>Invest Your Talent in Italy:</strong> Bolsas governamentais
                        <br><a href="https://www.studyininitaly.eu/" target="_blank" class="btn-custom">🔗 Study in Italy</a>
                    </li>
                    <li><strong>Bocconi Merit Awards:</strong> Universidade Bocconi
                        <br><a href="https://www.unibocconi.eu/wps/wcm/connect/bocconi/sitopubblico_en/tree/root/programs/bachelor+of+science/fees+funding+and+scholarships/merit+awards" target="_blank" class="btn-custom">🔗 Bocconi</a>
                    </li>
                    <li><strong>Erasmus+:</strong> Para estudantes europeus</li>
                    <li><strong>Baixas taxas:</strong> €150-4.000/ano em universidades públicas</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Itália possui <strong>universidades históricas</strong> com tradição milenar e excelência acadêmica reconhecida mundialmente.</p>
                <ul>
                    <li><strong>Università Bocconi:</strong> #7 mundial em negócios
                        <br><a href="https://www.unibocconi.eu/" target="_blank" class="btn-custom">🔗 Bocconi</a>
                    </li>
                    <li><strong>Sapienza University of Rome:</strong> #171 mundial
                        <br><a href="https://www.uniroma1.it/en/" target="_blank" class="btn-custom">🔗 Sapienza</a>
                    </li>
                    <li><strong>University of Bologna:</strong> Mais antiga do mundo (1088)
                        <br><a href="https://www.unibo.it/en/" target="_blank" class="btn-custom">🔗 Bologna</a>
                    </li>
                    <li><strong>100.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Itália possui uma <strong>grande comunidade brasileira</strong> de aproximadamente 50.000 pessoas, bem integrada e ativa.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Roma, Milão, Florença, Veneza</li>
                    <li><strong>Organizações:</strong> ACIB, grupos culturais, associações</li>
                    <li><strong>Eventos:</strong> Festival do Brasil, Carnaval, eventos gastronômicos</li>
                    <li><strong>Recursos:</strong> Consulados, grupos no Facebook, restaurantes</li>
                    <li><strong>Trabalho:</strong> Turismo, gastronomia, moda, arte</li>
                </ul>
            </div>

            <!-- Cultura -->
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-wine-glass me-2"></i>Cultura e Costumes</h4>
                <p>A cultura italiana é conhecida pela <strong>arte, gastronomia, moda e estilo de vida</strong> únicos no mundo.</p>
                <ul>
                    <li><strong>Arte e história:</strong> Berço do Renascimento</li>
                    <li><strong>Gastronomia:</strong> Patrimônio UNESCO, diversidade regional</li>
                    <li><strong>Moda:</strong> Capital mundial da moda (Milão)</li>
                    <li><strong>Família:</strong> Valores familiares muito fortes</li>
                    <li><strong>La Dolce Vita:</strong> Arte de viver bem</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico italiano segue o <strong>padrão europeu</strong> com dois semestres.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Setembro/outubro - janeiro</li>
                    <li><strong>Segundo semestre:</strong> Fevereiro - junho/julho</li>
                    <li><strong>Aplicações:</strong> Até abril-maio</li>
                    <li><strong>Férias:</strong> Julho-setembro, dezembro-janeiro</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Itália, foque em <strong>excelência acadêmica e paixão pela cultura italiana</strong>.</p>
                <ul>
                    <li><strong>Inglês:</strong> IELTS 6.0-6.5 ou TOEFL 80-90</li>
                    <li><strong>Italiano:</strong> B1-B2 recomendado</li>
                    <li><strong>Documentos:</strong> Histórico, diploma, carta de motivação</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studyininitaly.eu/" target="_blank" class="btn-custom">🎓 Study in Italy</a>
                        <br><a href="https://www.universitaly.it/" target="_blank" class="btn-custom">🏆 Universitaly</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <ul>
                    ...
                    <li><strong>Salário:</strong> €8-12/hora</li>
                    <li><strong>Setores:</strong> Turismo, gastronomia, moda, arte</li>
                    <li><strong>Pós-graduação:</strong> 1 ano para procurar trabalho</li>
                    <li><strong>Vantagem:</strong> Experiência em setores únicos italianos</li>
                </ul>
            </div>
        </div>
    </div>
