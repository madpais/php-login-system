...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'reinounido');
...
<head>
    ...
    <title>Reino Unido - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/gb.png" alt="Bandeira do Reino Unido" class="country-flag">
                            <h1 class="country-title">Reino Unido</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Reino Unido
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/reinounido_home.png" alt="Reino Unido - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇬🇧 Guia Completo: Estudar no Reino Unido</h2>
        <p>Descubra a terra de Oxford, Cambridge e tradição acadêmica centenária</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="reinounidoTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="reinounidoTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Inglês</strong> é o idioma oficial e nativo, oferecendo imersão completa na língua mais importante do mundo.</p>
                <ul>
                    <li><strong>Inglês britânico:</strong> Padrão mundial de excelência</li>
                    <li><strong>Sotaques regionais:</strong> Diversidade linguística rica</li>
                    <li><strong>Imersão total:</strong> Ambiente 100% em inglês</li>
                    <li><strong>Requisitos:</strong> IELTS 6.0-7.5 ou TOEFL 80-110</li>
                    <li><strong>Vantagem:</strong> Melhoria natural do inglês</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>O Reino Unido possui <strong>clima oceânico temperado</strong> com chuvas frequentes e temperaturas amenas.</p>
                <ul>
                    <li><strong>Inverno:</strong> 2-7°C, úmido e chuvoso</li>
                    <li><strong>Primavera:</strong> 8-15°C, agradável</li>
                    <li><strong>Verão:</strong> 15-25°C, ameno</li>
                    <li><strong>Outono:</strong> 10-15°C, chuvoso</li>
                    <li><strong>Chuva:</strong> Frequente o ano todo - sempre leve guarda-chuva!</li>
                </ul>
            </div>

            <!-- Custo de Vida -->
            <div class="tab-pane fade" id="custos" role="tabpanel">
                <h4><i class="fas fa-pound-sign me-2"></i>Custo de Vida</h4>
                <p>O Reino Unido tem <strong>custo de vida alto</strong>, especialmente em Londres, mas oferece educação de elite mundial.</p>
                <ul>
                    <li><strong>Acomodação:</strong> £400-1.500/mês</li>
                    <li><strong>Alimentação:</strong> £200-400/mês</li>
                    <li><strong>Transporte:</strong> £50-150/mês</li>
                    <li><strong>Total:</strong> £800-2.500/mês</li>
                    <li><strong>Londres vs outras cidades:</strong> 30-50% mais caro</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>O Reino Unido oferece <strong>bolsas prestigiosas</strong> para estudantes internacionais de excelência.</p>
                <ul>
                    <li><strong>Chevening Scholarships:</strong> Bolsa do governo britânico
                        <br><a href="https://www.chevening.org/" target="_blank" class="btn-custom">🔗 Chevening</a>
                    </li>
                    <li><strong>Commonwealth Scholarships:</strong> Para países da Commonwealth
                        <br><a href="https://cscuk.fcdo.gov.uk/" target="_blank" class="btn-custom">🔗 Commonwealth</a>
                    </li>
                    <li><strong>University scholarships:</strong> Oxford, Cambridge, Imperial, UCL</li>
                    <li><strong>Taxas:</strong> £10.000-45.000/ano (graduação/pós)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>O Reino Unido possui <strong>universidades de elite mundial</strong> com tradição centenária.</p>
                <ul>
                    <li><strong>University of Oxford:</strong> #2 mundial, mais antiga
                        <br><a href="https://www.ox.ac.uk/" target="_blank" class="btn-custom">🔗 Oxford</a>
                    </li>
                    <li><strong>University of Cambridge:</strong> #3 mundial
                        <br><a href="https://www.cam.ac.uk/" target="_blank" class="btn-custom">🔗 Cambridge</a>
                    </li>
                    <li><strong>Imperial College London:</strong> #6 mundial
                        <br><a href="https://www.imperial.ac.uk/" target="_blank" class="btn-custom">🔗 Imperial</a>
                    </li>
                    <li><strong>500.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>O Reino Unido possui uma <strong>grande comunidade brasileira</strong> de aproximadamente 300.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Londres, Manchester, Birmingham, Edinburgh</li>
                    <li><strong>Organizações:</strong> Casa do Brasil, Brazilian Society</li>
                    <li><strong>Eventos:</strong> Carnaval de Notting Hill, festivais brasileiros</li>
                    <li><strong>Recursos:</strong> Consulados, mídia brasileira, restaurantes</li>
                    <li><strong>Networking:</strong> Forte rede profissional brasileira</li>
                </ul>
            </div>

            <!-- Cultura -->
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-crown me-2"></i>Cultura e Costumes</h4>
                <p>A cultura britânica valoriza <strong>tradição, cortesia e fair play</strong> com rica herança histórica.</p>
                <ul>
                    <li><strong>Cortesia:</strong> "Please", "thank you", filas organizadas</li>
                    <li><strong>Pub culture:</strong> Centro da vida social</li>
                    <li><strong>Tradições:</strong> Chá das 5, monarquia, cricket</li>
                    <li><strong>Diversidade:</strong> Sociedade multicultural</li>
                    <li><strong>História:</strong> Museus, castelos, patrimônio mundial</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico britânico segue <strong>três termos</strong> com início em setembro.</p>
                <ul>
                    <li><strong>Autumn term:</strong> Setembro-dezembro</li>
                    <li><strong>Spring term:</strong> Janeiro-março</li>
                    <li><strong>Summer term:</strong> Abril-junho</li>
                    <li><strong>Aplicações:</strong> Outubro-janeiro (UCAS)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar no Reino Unido, foque em <strong>excelência acadêmica excepcional</strong> e liderança.</p>
                <ul>
                    <li><strong>Inglês:</strong> IELTS 6.0-7.5 ou TOEFL 80-110</li>
                    <li><strong>UCAS:</strong> Sistema central de aplicações</li>
                    <li><strong>Personal statement:</strong> Ensaio pessoal crucial</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.ucas.com/" target="_blank" class="btn-custom">🎓 UCAS</a>
                        <br><a href="https://www.chevening.org/" target="_blank" class="btn-custom">🏆 Chevening</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Sim!</strong> Estudantes podem trabalhar 20h/semana durante estudos e tempo integral nas férias.</p>
                <ul>
                    <li><strong>Permissão:</strong> 20h/semana + tempo integral nas férias</li>
                    <li><strong>Salário:</strong> £8-15/hora (salário mínimo)</li>
                    <li><strong>Setores:</strong> Varejo, hospitalidade, tutoria, pesquisa</li>
                    <li><strong>Pós-graduação:</strong> 2 anos para procurar trabalho (Graduate Route)</li>
                    <li><strong>Vantagem:</strong> Mercado de trabalho desenvolvido</li>
                </ul>
            </div>
        </div>
    </div>
