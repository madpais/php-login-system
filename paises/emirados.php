...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'emirados');
...
<head>
    ...
    <title>Emirados Árabes Unidos - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/ae.png" alt="Bandeira dos Emirados Árabes Unidos" class="country-flag">
                            <h1 class="country-title">Emirados Árabes</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Emirados Árabes
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/emirados_home.png" alt="Emirados Árabes Unidos - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇦🇪 Guia Completo: Estudar nos Emirados Árabes Unidos</h2>
        <p>Descubra a terra da inovação, luxo e educação internacional de primeira classe</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="emiradosTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="emiradosTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Árabe</strong> é o idioma oficial, mas o inglês é amplamente usado em educação e negócios internacionais.</p>
                <ul>
                    <li><strong>Árabe:</strong> Idioma oficial dos Emirados</li>
                    <li><strong>Inglês:</strong> Língua franca para negócios e educação</li>
                    <li><strong>Multilíngue:</strong> Hindi, Urdu, Tagalog também falados</li>
                    <li><strong>Programas em inglês:</strong> Maioria das universidades internacionais</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>Os Emirados possuem <strong>clima desértico</strong> quente e seco com verões extremamente quentes e invernos amenos.</p>
                <ul>
                    <li><strong>Verão (Mai-Set):</strong> 35-50°C, extremamente quente</li>
                    <li><strong>Inverno (Nov-Mar):</strong> 20-30°C, agradável</li>
                    <li><strong>Umidade:</strong> Alta no litoral (60-90%)</li>
                    <li><strong>Chuvas:</strong> Raras, principalmente no inverno</li>
                    <li><strong>Ar condicionado:</strong> Essencial e onipresente</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>Os Emirados têm <strong>custo de vida alto</strong>, mas oferecem infraestrutura de luxo e qualidade de vida excepcional.</p>
                <ul>
                    <li><strong>Acomodação:</strong> AED 2.000-8.000/mês (€500-2.000)</li>
                    <li><strong>Alimentação:</strong> AED 1.000-2.500/mês (€250-625)</li>
                    <li><strong>Transporte:</strong> AED 300-800/mês (€75-200)</li>
                    <li><strong>Total:</strong> AED 4.000-12.000/mês (€1.000-3.000)</li>
                    <li><strong>Vantagem:</strong> Sem impostos sobre renda</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>Os Emirados oferecem <strong>bolsas competitivas</strong> para atrair talentos internacionais.</p>
                <ul>
                    <li><strong>UAE Government Scholarships:</strong> Para estudantes internacionais
                        <br><a href="https://www.moe.gov.ae/" target="_blank" class="btn-custom">🔗 Ministry of Education UAE</a>
                    </li>
                    <li><strong>ADEK Scholarships:</strong> Abu Dhabi Department of Education
                        <br><a href="https://www.adek.gov.ae/" target="_blank" class="btn-custom">🔗 ADEK</a>
                    </li>
                    <li><strong>University scholarships:</strong> NYU Abu Dhabi, AUS, AUD</li>
                    <li><strong>Taxas:</strong> AED 40.000-120.000/ano (€10.000-30.000)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>Os Emirados possuem <strong>universidades internacionais</strong> com campi de instituições de elite mundial.</p>
                <ul>
                    <li><strong>NYU Abu Dhabi:</strong> Campus da New York University
                        <br><a href="https://nyuad.nyu.edu/" target="_blank" class="btn-custom">🔗 NYU Abu Dhabi</a>
                    </li>
                    <li><strong>American University of Sharjah:</strong> Educação americana
                        <br><a href="https://www.aus.edu/" target="_blank" class="btn-custom">🔗 AUS</a>
                    </li>
                    <li><strong>UAE University:</strong> Universidade nacional
                        <br><a href="https://www.uaeu.ac.ae/" target="_blank" class="btn-custom">🔗 UAEU</a>
                    </li>
                    <li><strong>77.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>Os Emirados possuem uma <strong>pequena comunidade brasileira</strong> de aproximadamente 2.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Dubai, Abu Dhabi, Sharjah</li>
                    <li><strong>Setores:</strong> Petróleo, aviação, turismo, construção</li>
                    <li><strong>Organizações:</strong> Câmara Brasil-Emirados</li>
                    <li><strong>Recursos:</strong> Consulado em Dubai</li>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                ...
                <p>A cultura emiradense combina <strong>tradições árabes com modernidade</strong> e tolerância internacional.</p>
                <ul>
                    <li><strong>Islã:</strong> Religião oficial, mas tolerância religiosa</li>
                    <li><strong>Hospitalidade:</strong> Tradição árabe de receber bem</li>
                    <li><strong>Modernidade:</strong> Sociedade cosmopolita e internacional</li>
                    <li><strong>Respeito:</strong> Às tradições locais e vestimentas</li>
                    <li><strong>Luxo:</strong> Padrão de vida elevado e infraestrutura de primeira</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico emiradense segue <strong>três semestres</strong> com início em setembro.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Setembro-dezembro</li>
                    <li><strong>Segundo semestre:</strong> Janeiro-maio</li>
                    <li><strong>Semestre de verão:</strong> Junho-agosto (opcional)</li>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar nos Emirados, foque em <strong>excelência acadêmica e interesse em inovação</strong>.</p>
                <ul>
                    ...
                    <li><strong>Áreas prioritárias:</strong> Engenharia, negócios, tecnologia</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studyintheuae.com/" target="_blank" class="btn-custom">🎓 Study in UAE</a>
                        <br><a href="https://nyuad.nyu.edu/" target="_blank" class="btn-custom">🏆 NYU Abu Dhabi</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Limitado!</strong> Estudantes podem trabalhar apenas 20h/semana com permissão especial.</p>
                <ul>
                    <li><strong>Permissão:</strong> 20h/semana com autorização da universidade</li>
                    <li><strong>Salário:</strong> AED 15-30/hora</li>
                    <li><strong>Setores:</strong> Tutoria, pesquisa, serviços</li>
                    <li><strong>Pós-graduação:</strong> 1 ano para procurar trabalho</li>
                    <li><strong>Vantagem:</strong> Hub internacional de negócios</li>
                </ul>
            </div>
        </div>
    </div>
