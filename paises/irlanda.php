...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'irlanda');
...
<head>
    ...
    <title>Irlanda - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/ie.png" alt="Bandeira da Irlanda" class="country-flag">
                            <h1 class="country-title">Irlanda</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Irlanda
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/irlanda_home.png" alt="Irlanda - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇮🇪 Guia Completo: Estudar na Irlanda</h2>
        <p>Descubra a Ilha Esmeralda com educação de qualidade e cultura acolhedora</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="irlandaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="irlandaTabContent">
            <!-- Idiomas -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idiomas Oficiais</h4>
                <p>A Irlanda possui <strong>dois idiomas oficiais</strong>: Inglês e Irlandês (Gaeilge), sendo o inglês predominante na educação e negócios.</p>
                <ul>
                    <li><strong>Inglês:</strong> Falado por 98% da população</li>
                    <li><strong>Irlandês (Gaeilge):</strong> Idioma tradicional, falado por 40%</li>
                    <li><strong>Vantagem:</strong> País nativo de língua inglesa</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Irlanda possui <strong>clima oceânico temperado</strong> com chuvas frequentes e temperaturas amenas.</p>
                <ul>
                    <li><strong>Inverno (Dez-Fev):</strong> 4-8°C, chuvoso</li>
                    <li><strong>Primavera (Mar-Mai):</strong> 8-14°C, variável</li>
                    <li><strong>Verão (Jun-Ago):</strong> 14-20°C, mais seco</li>
                    <li><strong>Outono (Set-Nov):</strong> 10-15°C, chuvoso</li>
                    <li><strong>Chuva:</strong> 150+ dias por ano</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Irlanda tem <strong>custo de vida alto</strong>, especialmente em Dublin, mas oferece excelentes oportunidades de trabalho.</p>
                <ul>
                    <li><strong>Acomodação:</strong> €400-1500/mês</li>
                    <li><strong>Alimentação:</strong> €250-400/mês</li>
                    <li><strong>Transporte:</strong> €100-150/mês</li>
                    <li><strong>Total:</strong> €1000-2500/mês</li>
                    <li><strong>Trabalho:</strong> Salários altos compensam custos</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Irlanda oferece <strong>diversas bolsas</strong> para estudantes internacionais, especialmente em áreas de tecnologia e pesquisa.</p>
                <ul>
                    <li><strong>Government of Ireland Scholarships:</strong> Bolsas governamentais
                        <br><a href="https://www.gov.ie/en/service/c0f1d9-government-of-ireland-scholarships/" target="_blank" class="btn-custom">🔗 GOI Scholarships</a>
                    </li>
                    <li><strong>Trinity College Dublin:</strong> Várias bolsas disponíveis
                        <br><a href="https://www.tcd.ie/study/international/scholarships/" target="_blank" class="btn-custom">🔗 TCD Scholarships</a>
                    </li>
                    <li><strong>UCD Global:</strong> Bolsas para estudantes internacionais
                        <br><a href="https://www.ucd.ie/global/scholarships/" target="_blank" class="btn-custom">🔗 UCD Scholarships</a>
                    </li>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Irlanda possui <strong>universidades de prestígio mundial</strong> com forte tradição acadêmica e pesquisa.</p>
                <ul>
                    <li><strong>Trinity College Dublin:</strong> #101 mundial, mais antiga (1592)
                        <br><a href="https://www.tcd.ie/" target="_blank" class="btn-custom">🔗 Trinity College</a>
                    </li>
                    <li><strong>University College Dublin:</strong> #173 mundial, maior da Irlanda
                        <br><a href="https://www.ucd.ie/" target="_blank" class="btn-custom">🔗 UCD</a>
                    </li>
                    <li><strong>University College Cork:</strong> #298 mundial, forte em pesquisa
                        <br><a href="https://www.ucc.ie/" target="_blank" class="btn-custom">🔗 UCC</a>
                    </li>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Irlanda possui uma <strong>vibrante comunidade brasileira</strong> de aproximadamente 15.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Dublin, Cork, Galway</li>
                    <li><strong>Organizações:</strong> Brazilian Community in Ireland, grupos culturais</li>
                    ...
                    <li><strong>Trabalho:</strong> Muitos brasileiros em tech e hospitality</li>
                </ul>
            </div>

            <!-- Cultura -->
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-clover me-2"></i>Cultura e Costumes</h4>
                <p>A cultura irlandesa é conhecida pela <strong>hospitalidade, música e tradições</strong> ricas.</p>
                <ul>
                    <li><strong>Hospitalidade:</strong> "Céad míle fáilte" - cem mil boas-vindas</li>
                    <li><strong>Música:</strong> Tradição musical muito forte</li>
                    <li><strong>Pubs:</strong> Centro da vida social irlandesa</li>
                    <li><strong>Festivais:</strong> St. Patrick's Day, Bloomsday</li>
                    <li><strong>Literatura:</strong> Tradição literária rica (Joyce, Yeats)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico irlandês segue o <strong>padrão europeu</strong> com dois semestres.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Setembro-dezembro</li>
                    <li><strong>Segundo semestre:</strong> Janeiro-maio</li>
                    <li><strong>Aplicações:</strong> Até 1º de fevereiro (CAO)</li>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Irlanda, foque em <strong>excelência acadêmica e proficiência em inglês</strong>.</p>
                <ul>
                    ...
                    <li><strong>CAO:</strong> Sistema central de aplicações</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.educationinireland.com/" target="_blank" class="btn-custom">🎓 Education in Ireland</a>
                        <br><a href="https://www.cao.ie/" target="_blank" class="btn-custom">🏆 CAO</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <ul>
                    ...
                    <li><strong>Salário:</strong> €10.50-15/hora (salário mínimo)</li>
                    <li><strong>Setores:</strong> Tech, hospitality, retail, pesquisa</li>
                    <li><strong>Pós-graduação:</strong> 2 anos para procurar trabalho</li>
                    <li><strong>Tech hub:</strong> Google, Facebook, Apple têm sede europeia</li>
                </ul>
            </div>
        </div>
    </div>
