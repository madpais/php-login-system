...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'indonesia');
...
<head>
    ...
    <title>Indonésia - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/id.png" alt="Bandeira da Indonésia" class="country-flag">
                            <h1 class="country-title">Indonésia</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Indonésia
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/indonesia_home.png" alt="Indonésia - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇮🇩 Guia Completo: Estudar na Indonésia</h2>
        <p>Descubra o maior arquipélago do mundo com cultura rica e custos baixos</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="indonesiaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="indonesiaTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Bahasa Indonesia</strong> é o idioma oficial. Inglês é amplamente usado na educação superior e negócios.</p>
                <ul>
                    <li><strong>Bahasa Indonesia:</strong> 275 milhões de falantes</li>
                    <li><strong>Inglês:</strong> Usado em universidades e programas internacionais</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Indonésia possui <strong>clima tropical equatorial</strong> quente e úmido o ano todo.</p>
                <ul>
                    <li><strong>Temperatura:</strong> 24-32°C constante</li>
                    <li><strong>Estação seca:</strong> Maio-setembro</li>
                    <li><strong>Estação chuvosa:</strong> Outubro-abril</li>
                    <li><strong>Umidade:</strong> 70-90%</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Indonésia oferece <strong>custo de vida muito baixo</strong> para estudantes internacionais.</p>
                <ul>
                    <li><strong>Acomodação:</strong> Rp 1-5 milhões/mês (€60-300)</li>
                    <li><strong>Alimentação:</strong> Rp 1-2 milhões/mês (€60-120)</li>
                    <li><strong>Transporte:</strong> Rp 500k-1 milhão/mês (€30-60)</li>
                    <li><strong>Total:</strong> Rp 3-8 milhões/mês (€180-480)</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Indonésia oferece <strong>bolsas governamentais</strong> e custos educacionais acessíveis.</p>
                <ul>
                    <li><strong>KNB Scholarship:</strong> Bolsa do governo indonésio
                        <br><a href="https://www.knb.ristekdikti.go.id/" target="_blank" class="btn-custom">🔗 KNB</a>
                    </li>
                    <li><strong>LPDP Scholarship:</strong> Para pós-graduação</li>
                    <li><strong>Bolsas universitárias:</strong> UI, ITB, UGM</li>
                    <li><strong>Baixas taxas:</strong> $1.000-3.000/ano</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Indonésia possui <strong>universidades em crescimento</strong> com programas internacionais.</p>
                <ul>
                    <li><strong>University of Indonesia (UI):</strong> Mais prestigiosa
                        <br><a href="https://www.ui.ac.id/en/" target="_blank" class="btn-custom">🔗 UI</a>
                    </li>
                    <li><strong>Institut Teknologi Bandung (ITB):</strong> Líder em tecnologia
                        <br><a href="https://www.itb.ac.id/en" target="_blank" class="btn-custom">🔗 ITB</a>
                    </li>
                    <li><strong>Universitas Gadjah Mada (UGM):</strong> Tradicional
                        <br><a href="https://ugm.ac.id/en/" target="_blank" class="btn-custom">🔗 UGM</a>
                    </li>
                    <li><strong>15.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Indonésia possui uma <strong>pequena comunidade brasileira</strong> de aproximadamente 1.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Jacarta, Surabaya, Bandung</li>
                    <li><strong>Setores:</strong> Negócios, educação, ONGs</li>
                    <li><strong>Organizações:</strong> Câmara Brasil-Indonésia</li>
                    <li><strong>Recursos:</strong> Embaixada em Jacarta</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                ...
                <p>A cultura indonésia é <strong>diversa e hospitaleira</strong> com influências islâmicas, hindus e locais.</p>
                <ul>
                    <li><strong>Diversidade:</strong> 17.000 ilhas, 300 grupos étnicos</li>
                    <li><strong>Religião:</strong> 87% muçulmanos, tolerância religiosa</li>
                    <li><strong>Hospitalidade:</strong> "Ramah tamah" - cultura acolhedora</li>
                    <li><strong>Culinária:</strong> Rica e variada, influências asiáticas</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico indonésio segue <strong>dois semestres</strong> com início em agosto/setembro.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Agosto/setembro - janeiro</li>
                    <li><strong>Segundo semestre:</strong> Fevereiro - julho</li>
                    <li><strong>Aplicações:</strong> Março-junho</li>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Indonésia, foque em <strong>boa performance acadêmica e interesse cultural</strong>.</p>
                <ul>
                    <li><strong>Inglês:</strong> IELTS 5.5-6.5 ou TOEFL 70-90</li>
                    <li><strong>Documentos:</strong> Histórico, diploma, carta de motivação</li>
                    <li><strong>KNB:</strong> Processo online específico</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studyinindonesia.go.id/" target="_blank" class="btn-custom">🎓 Study in Indonesia</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Limitado!</strong> Estudantes podem trabalhar apenas com permissões especiais.</p>
                <ul>
                    ...
                    <li><strong>Ensino:</strong> Aulas particulares possíveis</li>
                    <li><strong>Pós-graduação:</strong> Oportunidades em empresas multinacionais</li>
                </ul>
            </div>
        </div>
    </div>
