...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'noruega');
...
<head>
    ...
    <title>Noruega - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/no.png" alt="Bandeira da Noruega" class="country-flag">
                            <h1 class="country-title">Noruega</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Noruega
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/noruega_home.png" alt="Noruega - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇳🇴 Guia Completo: Estudar na Noruega</h2>
        <p>Descubra a terra dos fiordes, aurora boreal e educação gratuita de qualidade mundial</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="noruegaTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="noruegaTabContent">
            <!-- Idioma -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idioma Oficial</h4>
                <p><strong>Norueguês</strong> é o idioma oficial, mas a Noruega tem excelente proficiência em inglês. Muitos programas são oferecidos em inglês.</p>
                <ul>
                    <li><strong>Norueguês:</strong> 5,4 milhões de falantes</li>
                    <li><strong>Inglês:</strong> 95% de proficiência - um dos países mais fluentes</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>A Noruega possui <strong>clima subártico e oceânico</strong> com invernos longos e frios, verões amenos e aurora boreal.</p>
                <ul>
                    <li><strong>Inverno (Nov-Mar):</strong> -10 a 5°C, neve abundante</li>
                    <li><strong>Primavera (Abr-Mai):</strong> 5-15°C, degelo</li>
                    <li><strong>Verão (Jun-Ago):</strong> 15-25°C, sol da meia-noite</li>
                    <li><strong>Outono (Set-Out):</strong> 5-15°C, aurora boreal</li>
                    <li><strong>Especial:</strong> Sol da meia-noite no verão, noite polar no inverno</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>A Noruega tem <strong>custo de vida muito alto</strong>, mas oferece educação gratuita e excelente qualidade de vida.</p>
                <ul>
                    <li><strong>Acomodação:</strong> NOK 4.000-12.000/mês (€350-1.050)</li>
                    <li><strong>Alimentação:</strong> NOK 3.000-5.000/mês (€260-440)</li>
                    <li><strong>Transporte:</strong> NOK 600-1.000/mês (€50-90)</li>
                    <li><strong>Total:</strong> NOK 10.000-20.000/mês (€880-1.750)</li>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>A Noruega oferece <strong>educação gratuita</strong> e diversas bolsas para custos de vida.</p>
                <ul>
                    <li><strong>Educação gratuita:</strong> Universidades públicas sem taxas
                        <br><a href="https://www.studyinnorway.no/" target="_blank" class="btn-custom">🔗 Study in Norway</a>
                    </li>
                    <li><strong>Quota Scheme:</strong> Bolsas para países em desenvolvimento</li>
                    <li><strong>Lånekassen:</strong> Empréstimos estudantis para custos de vida</li>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>A Noruega possui <strong>universidades de excelência</strong> com forte tradição em pesquisa e sustentabilidade.</p>
                <ul>
                    <li><strong>University of Oslo:</strong> #119 mundial, mais prestigiosa
                        <br><a href="https://www.uio.no/english/" target="_blank" class="btn-custom">🔗 UiO</a>
                    </li>
                    <li><strong>Norwegian University of Science and Technology:</strong> #363 mundial
                        <br><a href="https://www.ntnu.edu/" target="_blank" class="btn-custom">🔗 NTNU</a>
                    </li>
                    <li><strong>University of Bergen:</strong> #194 mundial
                        <br><a href="https://www.uib.no/en/" target="_blank" class="btn-custom">🔗 UiB</a>
                    </li>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>A Noruega possui uma <strong>pequena comunidade brasileira</strong> de aproximadamente 3.000 pessoas.</p>
                <ul>
                    <li><strong>Principais cidades:</strong> Oslo, Bergen, Trondheim, Stavanger</li>
                    <li><strong>Setores:</strong> Petróleo, tecnologia, pesquisa, educação</li>
                    <li><strong>Organizações:</strong> Associação Brasil-Noruega</li>
                    <li><strong>Recursos:</strong> Embaixada em Oslo</li>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-mountain me-2"></i>Cultura e Costumes</h4>
                <p>A cultura norueguesa valoriza <strong>igualdade, natureza e simplicidade</strong> com forte conexão com o meio ambiente.</p>
                <ul>
                    <li><strong>Igualdade:</strong> Sociedade muito igualitária</li>
                    <li><strong>Natureza:</strong> "Friluftsliv" - vida ao ar livre</li>
                    <li><strong>Simplicidade:</strong> "Janteloven" - modéstia e humildade</li>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico norueguês segue o <strong>padrão europeu</strong> com dois semestres.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Agosto-dezembro</li>
                    <li><strong>Segundo semestre:</strong> Janeiro-junho</li>
                    <li><strong>Aplicações:</strong> Até 1º de março (NOKUT)</li>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar na Noruega, foque em <strong>excelência acadêmica e interesse em sustentabilidade</strong>.</p>
                <ul>
                    ...
                    <li><strong>NOKUT:</strong> Reconhecimento de qualificações</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studyinnorway.no/" target="_blank" class="btn-custom">🎓 Study in Norway</a>
                        <br><a href="https://www.nokut.no/" target="_blank" class="btn-custom">🏆 NOKUT</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <ul>
                    ...
                    <li><strong>Salário:</strong> NOK 180-250/hora (€16-22)</li>
                    <li><strong>Setores:</strong> Tecnologia, petróleo, pesquisa, turismo</li>
