...
$resultado_visita = registrarVisitaPais($_SESSION['usuario_id'], 'singapura');
...
<head>
    ...
    <title>Singapura - Guia Completo para Estudantes - DayDreaming</title>
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-start mb-3 mb-md-0">
                        <div class="logo-container">
                            ...
                            <img src="https://flagcdn.com/w80/sg.png" alt="Bandeira de Singapura" class="country-flag">
                            <h1 class="country-title">Singapura</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 text-center text-md-end">
                        <nav class="breadcrumb-nav d-inline-block">
                            ...
                            <span class="separator">›</span>
                            <span class="current">
                                <i class="fas fa-map-marker-alt me-1"></i>Singapura
                            </span>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid hero-image-container">
        <img src="../imagens/singapura_home.png" alt="Singapura - Paisagem" class="hero-image">
    </div>
    ...
    <div class="section-title">
        <h2>🇸🇬 Guia Completo: Estudar em Singapura</h2>
        <p>Descubra a cidade-estado asiática com educação de classe mundial e multiculturalismo</p>
    </div>

    <!-- Menu de Navegação por Abas -->
    <div class="container">
        <ul class="nav nav-tabs justify-content-center" id="singapuraTab" role="tablist">
        ...
        <!-- Conteúdo das Abas -->
        <div class="tab-content" id="singapuraTabContent">
            <!-- Idiomas -->
            <div class="tab-pane fade show active" id="idioma" role="tabpanel">
                <h4><i class="fas fa-language me-2"></i>Idiomas Oficiais</h4>
                <p>Singapura possui <strong>quatro idiomas oficiais</strong> com inglês como língua principal de educação e negócios.</p>
                <ul>
                    <li><strong>Inglês:</strong> Língua principal de educação e negócios</li>
                    <li><strong>Mandarim:</strong> Falado pela comunidade chinesa (74%)</li>
                    <li><strong>Malaio:</strong> Idioma nacional, falado por 13%</li>
                    <li><strong>Tamil:</strong> Falado pela comunidade indiana (9%)</li>
            ...
            <div class="tab-pane fade" id="clima" role="tabpanel">
                ...
                <p>Singapura possui <strong>clima tropical equatorial</strong> quente e úmido o ano todo, sem estações definidas.</p>
                <ul>
                    <li><strong>Temperatura:</strong> 25-32°C constante</li>
                    <li><strong>Umidade:</strong> 80-90% alta umidade</li>
                    <li><strong>Chuvas:</strong> Frequentes, especialmente à tarde</li>
                    <li><strong>Monção:</strong> Dezembro-março (mais chuvoso)</li>
                    <li><strong>Ar condicionado:</strong> Essencial em todos os lugares</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="custos" role="tabpanel">
                ...
                <p>Singapura tem <strong>custo de vida alto</strong>, mas oferece excelente qualidade de vida e infraestrutura de primeira classe.</p>
                <ul>
                    <li><strong>Acomodação:</strong> SGD 800-2.500/mês (€550-1.750)</li>
                    <li><strong>Alimentação:</strong> SGD 400-800/mês (€280-560)</li>
                    <li><strong>Transporte:</strong> SGD 100-150/mês (€70-105)</li>
                    <li><strong>Total:</strong> SGD 1.500-4.000/mês (€1.050-2.800)</li>
            ...
            <div class="tab-pane fade" id="bolsas" role="tabpanel">
                ...
                <p>Singapura oferece <strong>bolsas competitivas</strong> para atrair os melhores talentos internacionais.</p>
                <ul>
                    <li><strong>Singapore International Graduate Award (SINGA):</strong> Para PhD
                        <br><a href="https://www.a-star.edu.sg/Scholarships/for-graduate-studies/singapore-international-graduate-award-singa" target="_blank" class="btn-custom">🔗 SINGA</a>
                    </li>
                    <li><strong>NUS Global Merit Scholarship:</strong> Para graduação
                        <br><a href="https://www.nus.edu.sg/oam/scholarships" target="_blank" class="btn-custom">🔗 NUS Scholarships</a>
                    </li>
                    <li><strong>NTU Scholarships:</strong> Várias modalidades
                        <br><a href="https://www.ntu.edu.sg/admissions/undergraduate/scholarships" target="_blank" class="btn-custom">🔗 NTU Scholarships</a>
                    </li>
                    <li><strong>Cobertura:</strong> Mensalidade + moradia + alimentação</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="universidades" role="tabpanel">
                ...
                <p>Singapura possui <strong>universidades de elite mundial</strong> com forte foco em pesquisa e inovação.</p>
                <ul>
                    <li><strong>National University of Singapore (NUS):</strong> #11 mundial
                        <br><a href="https://www.nus.edu.sg/" target="_blank" class="btn-custom">🔗 NUS</a>
                    </li>
                    <li><strong>Nanyang Technological University (NTU):</strong> #26 mundial
                        <br><a href="https://www.ntu.edu.sg/" target="_blank" class="btn-custom">🔗 NTU</a>
                    </li>
                    <li><strong>Singapore Management University (SMU):</strong> Especializada em negócios
                        <br><a href="https://www.smu.edu.sg/" target="_blank" class="btn-custom">🔗 SMU</a>
                    </li>
                    <li><strong>50.000+ estudantes internacionais</strong></li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="comunidade-br" role="tabpanel">
                ...
                <p>Singapura possui uma <strong>pequena comunidade brasileira</strong> de aproximadamente 1.500 pessoas.</p>
                <ul>
                    <li><strong>Concentração:</strong> Principalmente na região central</li>
                    <li><strong>Setores:</strong> Finanças, tecnologia, petróleo, educação</li>
                    <li><strong>Organizações:</strong> Câmara Brasil-Singapura</li>
                    <li><strong>Recursos:</strong> Consulado brasileiro</li>
            ...
            <div class="tab-pane fade" id="cultura" role="tabpanel">
                <h4><i class="fas fa-globe-asia me-2"></i>Cultura e Costumes</h4>
                <p>A cultura singapurense é <strong>multicultural e cosmopolita</strong> com harmonia entre diferentes etnias e religiões.</p>
                <ul>
                    <li><strong>Multiculturalismo:</strong> Chineses, malaios, indianos, expatriados</li>
                    <li><strong>Tolerância religiosa:</strong> Budismo, islamismo, cristianismo, hinduísmo</li>
                    <li><strong>Eficiência:</strong> Sociedade altamente organizada e eficiente</li>
                    <li><strong>Leis rigorosas:</strong> Regras claras e multas por infrações</li>
                    <li><strong>Food culture:</strong> Hawker centers, diversidade gastronômica</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="calendario" role="tabpanel">
                ...
                <p>O ano acadêmico singapurense segue <strong>dois semestres</strong> com início em agosto.</p>
                <ul>
                    <li><strong>Primeiro semestre:</strong> Agosto-dezembro</li>
                    <li><strong>Segundo semestre:</strong> Janeiro-maio</li>
                    <li><strong>Aplicações:</strong> Outubro-março</li>
                    <li><strong>Férias:</strong> Junho-julho, dezembro-janeiro</li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="guia" role="tabpanel">
                ...
                <p>Para estudar em Singapura, foque em <strong>excelência acadêmica e áreas STEM</strong>.</p>
                <ul>
                    <li><strong>Inglês:</strong> IELTS 6.5-7.0 ou TOEFL 90-100</li>
                    <li><strong>Documentos:</strong> Histórico, diploma, carta de motivação, referências</li>
                    <li><strong>Áreas prioritárias:</strong> Engenharia, ciências, tecnologia, negócios</li>
                    <li><strong>Links úteis:</strong>
                        <br><a href="https://www.studyinsingapore.edu.sg/" target="_blank" class="btn-custom">🎓 Study in Singapore</a>
                        <br><a href="https://www.nus.edu.sg/" target="_blank" class="btn-custom">🏆 NUS</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-pane fade" id="trabalho" role="tabpanel">
                ...
                <p><strong>Limitado!</strong> Estudantes podem trabalhar apenas 16h/semana com permissão.</p>
                <ul>
                    <li><strong>Permissão:</strong> 16h/semana apenas para estudantes de universidades aprovadas</li>
                    <li><strong>Salário:</strong> SGD 8-15/hora</li>
                    <li><strong>Setores:</strong> Tutoria, pesquisa, serviços</li>
                    <li><strong>Pós-graduação:</strong> Excelentes oportunidades em hub financeiro</li>
                    <li><strong>Vantagem:</strong> Gateway para Ásia, hub de multinacionais</li>
                </ul>
            </div>
        </div>
    </div>
